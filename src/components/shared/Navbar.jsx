  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="max-w-screen shadow-md py-2"
      >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="fixed z-50 bg-base-300 lg:hidden md:top-12 sm:top-11 top-11 right-0 sm:w-2/3 w-full h-full shadow-lg p-5"
            >
